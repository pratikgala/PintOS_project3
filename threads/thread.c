...
thread_init (void) 
{
  ...
  //$$----------------------------------- 
  // adding a zero parameter to init_thread
               ...
               thread_func *function, void *aux) 
{
  ...
  //-------------------------------------------------
  //initiaze the stack of the thread for first run
  //-------------------------------------------------
...
thread_exit (void) 
{
  ...
  /* also call syscall_exit to close the file descriptors if open and are related
 to the thread
which is exting */
syscall_exit();
#ifdef USERPROG
